...
ThemeData lightTheme = ThemeData.light().copyWith(
  ...
  focusColor: const Color.fromRGBO(236, 242, 248, 1),
  primaryColor: const Color.fromRGBO(21, 21, 21, 1),
  primaryColorLight: const Color.fromRGBO(224, 224, 224, .9),
  primaryColorDark: const Color.fromRGBO(21, 21, 21, 1),
  iconTheme: const IconThemeData(color: Color.fromRGBO(21, 21, 21, 1)),
  ...
  textTheme: TextTheme(
    ...
    headlineLarge: TextStyle(
      fontSize: 70.sp,
      color: const Color.fromRGBO(21, 21, 21, .702),
      fontFamily: 'family',
      fontWeight: FontWeight.normal,
    ),
    ...
    bodyLarge: TextStyle(
      fontSize: 100.sp,
      color: const Color.fromRGBO(21, 21, 21, 0.702),
      fontFamily: 'family',
      fontWeight: FontWeight.normal,
    ),
    bodyMedium: TextStyle(
      fontSize: 40.sp,
      color: const Color.fromRGBO(66, 66, 66, 0.702),
      fontFamily: 'family',
      fontWeight: FontWeight.normal,
    ),
    bodySmall: TextStyle(
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    fillColor: const Color.fromRGBO(236, 242, 248, 1),
    iconColor: const Color.fromRGBO(224, 224, 224, 1),
    focusColor: const Color.fromRGBO(236, 242, 248, 1),
    hoverColor: const Color.fromRGBO(236, 242, 248, 1),
